    ...
    <div class="recline-flot"> \
      <div class="panel graph" style="display: block;"> \
        <div class="js-temp-notice alert alert-block"> \
         <p>En este momento no hay gráfica  porque no sabemos los campos que deseas utilizar. Por favor déjanos saber <strong>usando el menú a la derecha</strong> y la gráfica ha de aparecer automáticamente. \
        </div> \
      </div> \
    </div> \
',
